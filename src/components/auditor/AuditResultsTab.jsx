      ...
      <CardContent>
        ...
        {auditResults && (
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-2xl font-semibold mb-3 text-orange-300">Detected Vulnerabilities ({auditResults.vulnerabilities.length})</h3>
              {auditResults.vulnerabilities.length === 0 && <p className="text-gray-300">No direct vulnerabilities detected. Good job!</p>}
              <div className="space-y-4">
                {auditResults.vulnerabilities.map(vuln => (
                  <Card key={vuln.id} className="bg-slate-800/50 border-slate-700/70">
                    <CardHeader>
